  ...
  function importFn(attr, cb) {
    ...
    if (attr === '$check')
      return function(context) {
        // Replace context arguments by
        // - old object (in context)
        // - resulting object (in context)
        Array.prototype.splice.call(arguments, 0, 1, context.get('old'), context.get('res'));
    ...
    return function(context) {
      ...
      Array.prototype.splice.call(arguments, 0, 1,
        context.get('old', {})[attr],
        context.get('raw', {})[attr],
      ...
      return cb.apply(this, arguments)
        ...
        .then(modifyAttrVal(attr, context.get('res')))
      ;
    };
  }
  ...
  function exportFn(attr, cb) {
    ...
    if (attr === '$check')
      return function(context) {
        // Replace context arguments by
        // - resulting object (in context)
        Array.prototype.splice.call(arguments, 0, 1, context.get('res'));
        // Execute action with modified args
        return cb.apply(this, arguments);
      };
