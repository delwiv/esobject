...
Index.prototype.get = function get(Type, id, params) {
  return this.$client.get(_.extend({}, params || {}, {
    index: this.name,
    type: Type.lowerName,
    id: id,
  }))
...
Index.prototype.search = function search(Types, request, params) {
  ...
  return this.$client.search(_.extend({
    index: this.name,
    type: lowerTypeNames,
...
Index.prototype.save = function(obj, params) {
  ...
  return this.$client[obj._version || params.force ? 'index' : 'create'](_.extend({
    index: this.name,
    type: obj._type,
    parent: obj._parent,
    id: obj._id,
...
Index.prototype.createTemplate = function(name, pattern, settings, params) {
  return this.$client.indices.putTemplate(_.extend({
    name: name,
    body: {
      template: pattern,
      settings: settings,
