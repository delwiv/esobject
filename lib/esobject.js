...
define(function(_, util, elasticsearch, strategies, methods, statics) {
  ...
  ESObject.create = function(descrObj) {
    ...
    Object.defineProperties(Class, {
      config: {
        ...
        value: {
          ...
          export: strategies.export(descrObj.export),
          // import actions generated in a callback
          import: strategies.import(descrObj.import),
        },
      },
      client: {
    ...
    return _.extend(Class, statics, function(oldVal, newVal) {
